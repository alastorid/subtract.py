...
// Vite's development pre-bundler cannot infer ONNX Runtime's adjacent WASM
// asset. An explicit URL is also more robust for GitHub Pages' nested base path.
ort.env.wasm.wasmPaths = { wasm: new URL(wasmUrl, window.location.href).href };
